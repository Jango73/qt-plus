...
long QTPLUSSHARED_EXPORT Set_MGRS_Parameters(double a,
                                              double f,
                                              char   *Ellipsoid_Code);
/*
...
void QTPLUSSHARED_EXPORT Get_MGRS_Parameters(double *a,
                                              double *f,
                                              char   *Ellipsoid_Code);
/*
...
long QTPLUSSHARED_EXPORT Convert_Geodetic_To_MGRS (double Latitude,
                                                    double Longitude,
                                                    long   Precision,
                                                    char *MGRS);
/*
...
long QTPLUSSHARED_EXPORT Convert_MGRS_To_Geodetic (char *MGRS,
                                                    double *Latitude,
                                                    double *Longitude);
/*
...
long QTPLUSSHARED_EXPORT Convert_UTM_To_MGRS (long Zone,
                                               char Hemisphere,
                                               double Easting,
                                               double Northing,
                                               long Precision,
...
long QTPLUSSHARED_EXPORT Convert_MGRS_To_UTM (char   *MGRS,
                                               long   *Zone,
                                               char   *Hemisphere,
                                               double *Easting,
                                               double *Northing);
...
long QTPLUSSHARED_EXPORT Convert_UPS_To_MGRS ( char   Hemisphere,
                                                double Easting,
                                                double Northing,
                                                long Precision,
                                                char *MGRS);
...
long QTPLUSSHARED_EXPORT Convert_MGRS_To_UPS ( char   *MGRS,
                                                char   *Hemisphere,
                                                double *Easting,
                                                double *Northing);
/*
...
long QTPLUSSHARED_EXPORT Make_MGRS_String (char* MGRS,
                                            long Zone,
