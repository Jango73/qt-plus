...
long QTPLUSSHARED_EXPORT Set_UTM_Parameters(double a,
                                             double f,
                                             long   override);
/*
...
void QTPLUSSHARED_EXPORT Get_UTM_Parameters(double *a,
                                             double *f,
                                             long   *override);
/*
...
long QTPLUSSHARED_EXPORT Convert_Geodetic_To_UTM (double Latitude,
                                                   double Longitude,
                                                   long   *Zone,
                                                   char   *Hemisphere,
                                                   double *Easting,
...
long QTPLUSSHARED_EXPORT Convert_UTM_To_Geodetic(long   Zone,
                                                  char   Hemisphere,
                                                  double Easting,
                                                  double Northing,
                                                  double *Latitude,
