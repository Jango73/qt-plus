...
long QTPLUSSHARED_EXPORT Set_Transverse_Mercator_Parameters(double a,
                                                             double f,
...
void QTPLUSSHARED_EXPORT Get_Transverse_Mercator_Parameters(double *a,
                                                             double *f,
                                                             double *Origin_Latitude,
                                                             double *Central_Meridian,
                                                             double *False_Easting,
...
long QTPLUSSHARED_EXPORT Convert_Geodetic_To_Transverse_Mercator (double Latitude,
                                                                   double Longitude,
                                                                   double *Easting,
                                                                   double *Northing);
...
long QTPLUSSHARED_EXPORT Convert_Transverse_Mercator_To_Geodetic (double Easting,
                                                                   double Northing,
                                                                   double *Latitude,
                                                                   double *Longitude);
