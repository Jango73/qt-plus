...
long QTPLUSSHARED_EXPORT Set_Polar_Stereographic_Parameters (double a,
                                                              double f,
...
void QTPLUSSHARED_EXPORT Get_Polar_Stereographic_Parameters (double *a,
                                                              double *f,
                                                              double *Latitude_of_True_Scale,
                                                              double *Longitude_Down_from_Pole,
                                                              double *False_Easting,
...
long QTPLUSSHARED_EXPORT Convert_Geodetic_To_Polar_Stereographic (double Latitude,
                                                                   double Longitude,
                                                                   double *Easting,
                                                                   double *Northing);
/*
...
long QTPLUSSHARED_EXPORT Convert_Polar_Stereographic_To_Geodetic (double Easting,
                                                                   double Northing,
                                                                   double *Latitude,
                                                                   double *Longitude);
