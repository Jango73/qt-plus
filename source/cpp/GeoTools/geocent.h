...
long QTPLUSSHARED_EXPORT Set_Geocentric_Parameters (double a,
                                                     double f);
/*
...
void QTPLUSSHARED_EXPORT Get_Geocentric_Parameters (double *a,
                                                     double *f);
/*
...
long QTPLUSSHARED_EXPORT Convert_Geodetic_To_Geocentric (double Latitude,
                                                          double Longitude,
                                                          double Height,
                                                          double *X,
                                                          double *Y,
...
void QTPLUSSHARED_EXPORT Convert_Geocentric_To_Geodetic (double X,
                                                          double Y,
                                                          double Z,
                                                          double *Latitude,
                                                          double *Longitude,
